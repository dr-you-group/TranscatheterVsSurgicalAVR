...
OhdsiRTools::checkUsagePackage("TavrSavr")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/TavrSavr.pdf")
shell("R CMD Rd2pdf ./ --output=extras/TavrSavr.pdf")
...
OhdsiRTools::createRenvLockFile("TavrSavr")
