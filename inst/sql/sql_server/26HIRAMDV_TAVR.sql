...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4189343,3654576,4111098,45766136)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (36676805)
...
JOIN #Codesets codesets on ((de.device_source_concept_id = codesets.concept_id and codesets.codeset_id = 1))
) C
