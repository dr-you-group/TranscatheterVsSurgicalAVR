...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19692316)
...
JOIN #Codesets codesets on ((de.device_source_concept_id = codesets.concept_id and codesets.codeset_id = 0))
) C
